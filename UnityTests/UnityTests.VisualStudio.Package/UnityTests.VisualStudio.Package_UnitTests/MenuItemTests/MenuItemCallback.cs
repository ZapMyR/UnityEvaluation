...
using Company.UnityTests_VisualStudio_Package;

namespace UnityTests.VisualStudio.Package_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new UnityTests_VisualStudio_PackagePackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(Company.UnityTests_VisualStudio_Package.GuidList.guidUnityTests_VisualStudio_PackageCmdSet, (int)Company.UnityTests_VisualStudio_Package.PkgCmdIDList.unityTestsCommandId);
